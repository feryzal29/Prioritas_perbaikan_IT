                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?php echo base_url('auth/login_process'); ?>" method="POST">
                                        <div class="form-group">
                                            <input type="text" name="nip" class="form-control form-control-user" placeholder="Masukan NIP...">
                                        </div>
                                        <div class="form-group">
